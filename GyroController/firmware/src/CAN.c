...
//                            printf("packet4: %u\r",(uint8_t)rxPacket.messageContents[4]);                          
                ...
                case POSITION_REACHED_REQUESTED:
                    ...
                    {
                        case RIGHTMOTORID:
                            storeMotorPositionReached(&RightMotor,(uint8_t)(dataCombination & 0x10));
                            break;
                        case LEFTMOTORID:
                            storeMotorPositionReached(&LeftMotor,(uint8_t)(dataCombination & 0x10));                            
                            break;
                        case ACTUATORMOTORID:
                            storeMotorPositionReached(&BucketActuator,(uint8_t)(dataCombination & 0x10));  
                            break;
                        case ARMMOTORID:
                            storeMotorPositionReached(&ArmMotor,(uint8_t)(dataCombination & 0x10));                          
                            break;
                        case PLOWMOTORID:
                            storeMotorPositionReached(&PlowMotor,(uint8_t)(dataCombination & 0x10));                            
                            break;
                    }
                    break;
                case REQUEST_TARGET_COUNTS:
                    ...
                    {
                        case RIGHTMOTORID:
                            storeMotorTargetCounts(&RightMotor,(dataCombination));
                            break;
                        case LEFTMOTORID:
                            storeMotorTargetCounts(&LeftMotor,(dataCombination ));                            
                            break;
                        case ACTUATORMOTORID:
                            storeMotorTargetCounts(&BucketActuator,(dataCombination ));  
                            break;
                        case ARMMOTORID:
                            storeMotorTargetCounts(&ArmMotor,(dataCombination ));                          
                            break;
                        case PLOWMOTORID:
                            storeMotorTargetCounts(&PlowMotor,(dataCombination ));                            
                            break;
                    }
                    break;
                case REQUEST_VELOCITY:
                    ...
                    {
                        case RIGHTMOTORID:
                            storeMotorVelocity(&RightMotor,(dataCombination ));
                            break;
                        case LEFTMOTORID:
                            storeMotorVelocity(&LeftMotor,(dataCombination ));                            
                            break;
                        case ACTUATORMOTORID:
                            storeMotorVelocity(&BucketActuator,(dataCombination ));  
                            break;
                        case ARMMOTORID:
                            storeMotorVelocity(&ArmMotor,(dataCombination ));                          
                            break;
                        case PLOWMOTORID:
                            storeMotorVelocity(&PlowMotor,(dataCombination ));                            
                            break;
                    }
                    break;
            }
