...
void initChangeNotification(intPin_t *pin0, intPin_t *pin1, intPin_t *pin2, intPin_t *pin3)
{
    pinArray[0] = &MotorPin1;
    pinArray[1] = &MotorPin2;
    pinArray[2] = &MasterPin1;
    pinArray[3] = &MasterPin2;
    int i;
