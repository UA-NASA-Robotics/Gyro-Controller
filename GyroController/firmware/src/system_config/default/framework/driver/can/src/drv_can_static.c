...
void DRV_CAN0_Initialize(void)
{
    ...
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER1, 0x1C4, CAN_SID);
    ...
    PLIB_CAN_FilterMaskConfigure(CAN_ID_1, CAN_FILTER_MASK1, 0xFF0, CAN_SID, CAN_FILTER_MASK_IDE_TYPE);
