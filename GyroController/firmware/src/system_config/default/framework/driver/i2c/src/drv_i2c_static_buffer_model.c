...
{
    /* Initialize I2C0 */
    PLIB_I2C_BaudRateSet(I2C_ID_4, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 100000);
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C4_MASTER, INT_PRIORITY_LEVEL6);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_I2C4_MASTER, INT_SUBPRIORITY_LEVEL3);

    /* Initialize fault interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_I2C_4_BUS);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_I2C_4_BUS);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C4_BUS, INT_DISABLE_INTERRUPT);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_I2C4_BUS, INT_SUBPRIORITY_LEVEL0);
