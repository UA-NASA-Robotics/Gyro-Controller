...
void __ISR(_I2C4_MASTER_VECTOR, ipl6AUTO) _IntHandlerDrvI2CMasterInstance0(void)
{
	DRV_I2C0_Tasks();
}


void __ISR(_I2C4_BUS_VECTOR, ipl0AUTO) _IntHandlerDrvI2CErrorInstance0(void)
{
...
void __ISR(_UART4_TX_VECTOR, ipl5AUTO) _IntHandlerDrvUsartTransmitInstance0(void)
{
    DRV_USART_TasksTransmit(sysObj.drvUsart0);
}
void __ISR(_UART4_RX_VECTOR, ipl5AUTO) _IntHandlerDrvUsartReceiveInstance0(void)
{
    DRV_USART_TasksReceive(sysObj.drvUsart0);
}
void __ISR(_UART4_FAULT_VECTOR, ipl5AUTO) _IntHandlerDrvUsartErrorInstance0(void)
{
...
void __ISR(_UART6_TX_VECTOR, ipl5AUTO) _IntHandlerDrvUsartTransmitInstance1(void)
{
    DRV_USART_TasksTransmit(sysObj.drvUsart1);
}
void __ISR(_UART6_RX_VECTOR, ipl5AUTO) _IntHandlerDrvUsartReceiveInstance1(void)
{
    DRV_USART_TasksReceive(sysObj.drvUsart1);
}
void __ISR(_UART6_FAULT_VECTOR, ipl5AUTO) _IntHandlerDrvUsartErrorInstance1(void)
{
