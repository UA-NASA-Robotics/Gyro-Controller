...
#define Master_UART         DRV_USART_INDEX_0       //Uart4(Silicon instance) | Instance 0 (harmony) | UART1_3RX & UART1_3TX (board Schematic) | PIN 18(TX) & PIN 17(RX) (Processor)
#define Motor_UART          DRV_USART_INDEX_1       //Uart6(Silicon instance) | Instance 1 (harmony) | UART1_2TX & UART1_2RX (board Schematic) | PIN 52(TX) & PIN 53(RX) (Processor)
